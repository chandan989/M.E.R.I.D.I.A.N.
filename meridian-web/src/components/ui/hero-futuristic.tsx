...
export const HeroFuturistic = () => {
  const titleWords = 'M.E.R.I.D.I.A.N. Your AI Companion'.split(' ');
  const subtitle = 'Navigate the future of creation with our intelligent partner.';
